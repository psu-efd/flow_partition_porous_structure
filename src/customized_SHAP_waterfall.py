...
def custom_waterfall(shap_values, max_display=10, show=True):
    ...
    plt.yticks(ytick_pos, yticklabels[:-1] + [label.split('=')[-1] for label in yticklabels[:-1]], fontsize=16)
    ...
    ax2.set_xticklabels([custom_prediction_text, ""], fontsize=14, ha="left")
    ...
    ax3.set_xticklabels([custom_prediction_text, " "], fontsize=14,
                        ha="left")
